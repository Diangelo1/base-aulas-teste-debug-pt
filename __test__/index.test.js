...
describe("Testes para Função Somar", () => {
    ...
    it("Deve lançar erro quando segundo valor for vazio", () => {
        expect(() => {
            Service.Somar(2, "")
        }).toThrow("Informe todos os valores");
    })
...
describe("Testes para função Radiciar", () => {
    ...
    it("Deve calcular raiz negativa com índice impar", () => {
        const result = Service.Radiciar(-27, 3);
        expect(result).toBe(-3);
    })

    // ← teste atualizado: agora lança erro em vez de retornar NaN
    it("Deve lançar erro raiz negativa com índice par", () => {
        expect(() => {
            Service.Radiciar(-16, 2)
        }).toThrow("Não é possível calcular raiz de índice par de número negativo");
    })
    ...
    it("Deve lançar erro quando numero for texto", () => {
        expect(() => {
            Service.Radiciar("a", 2)
        }).toThrow("Informe somente números");
    })

    it("Deve lançar erro quando índice da raiz for texto", () => {
        expect(() => {
            Service.Radiciar(25, "a")
        }).toThrow("Informe somente números");
    })
